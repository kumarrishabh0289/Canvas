...
class CreateAssign extends Component{
    ...
    submitCreate = (e) => {
        ...
        axios.put('http://localhost:3001/createassign',data)
            .then(response => {
            ...
            <div>
                ...
                <h1>Create New Assignment.</h1>
                        ...
                        <h4>Assignment Content</h4>
                            <textarea onChange = {this.contentChangeHandler} type="textarea" rows="6" cols="50" class="form-control" name="Content" placeholder="Assignment Content"/>
                        </div>
                        <br/>
                       
                        
                        <div style={{width: '30%'}}>
                            <button onClick = {this.submitCreate} class="btn btn-success">Create new Assignment</button>
                        </div> 
                </div> 
            </div>
        )
